package com.class8.eduAdmin.memcached;
...
public class SpyMemcachedClient implements DisposableBean {
	...
	public static final long DEFAULT_SHUDOW_TIMEOUT = 2500;
	public static final long DEFAULT_UPDATE_TIMEOUT = 2500;
	...
	public SpyMemcachedClient(MemcachedClient memcachedClient) {
		if(memcachedClient == null){
			throw new IllegalStateException("Memcached client instance cannot be null.");
		}
		this.memcachedClient = memcachedClient;
		this.shutdownTimeout = DEFAULT_SHUDOW_TIMEOUT;
